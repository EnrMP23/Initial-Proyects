...
if __name__ == '__main__':
    TOKEN = os.getenv('7309741382:AAETHbkJYLMha85xOyuvmdRTLm1WUPD2y0c')  # Usa una variable de entorno para el token
    APP_URL = os.getenv('https://api.telegram.org/bot7309741382:AAETHbkJYLMha85xOyuvmdRTLm1WUPD2y0c/setWebhook?url=https://initial-proyects.onrender.com
')  # Asegúrate de tener configurada esta variable en Render con la URL de tu app
